...
main()
{
    ...
    do{
        ...
        cout<<"7. mostrar"<<endl;
        cout<<"8. Buscar indice"<<endl;
        cout<<"9. Buscar por indice"<<endl;
        cout<<"10. salir"<<endl;
        cout<<"Ingrese opcion: ";
        cin>>op;
        switch(op)
        ...
        case 8:
            ...
            cout<<"Ingrese valor: ";
            cin>>valor;
            cout<<"El indice es: "<<buscar_indice(lista,valor);
            break;
        case 9:
            int indice;
            cout<<"Ingrese indice: ";
            cin>>indice;
            cout<<"La direccion del elemento es: "<<buscar_por_indice(lista,indice);
            break;
        case 10:
            break;
        default:
...
int buscar_indice(tlista lista, int valor)
{
    ...
    if(emptylist(lista))
        return -1;
    for(pnodo i=lista.inicio;i!=lista.fin->sig && a; i=i->sig)
        if(valor==i->dato)
        {
            a=false;
            cont++;
...
pnodo buscar_por_indice(tlista lista, int indice)
{
    ...
    if(emptylist(lista))
        return NULL;
    for(i=lista.inicio;i!=NULL && cont<indice; i=i->sig)
        cont++;
    if(cont==indice)
        return i;
    else
